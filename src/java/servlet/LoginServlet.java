...
//        processRequest(request, response);
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form method='post' action='check-login'>");
            out.println("<input type='text' name='user' placeholder='Username'><br>");
            out.println("<input type='password' name='pass' placeholder='Password'><br>");
